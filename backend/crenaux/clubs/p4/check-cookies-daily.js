#!/usr/bin/env node
/**
 * Script de vérification quotidienne des cookies P4 Padel Indoor
 * À exécuter via PM2 avec une tâche cron
 */
 ...
 */
async function main() {
  console.log('=== VÉRIFICATION QUOTIDIENNE DES COOKIES P4 PADEL INDOOR ===');
